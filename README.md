...
- *[x] [2025-11-26] 3.2 --> next functional version with data collection functions (took a while to get everything to work, sorry!)
    ...
    - POTENTIAL CONCERNS/CURRENT ISSUES: usernames aren't necessarily unique if two ppl have the same initials, last 4 digits of phone number, and month/year of birth. can add a category later to reduce chances of duplicates + some light graphics details to rework + optimize and comment code soon
